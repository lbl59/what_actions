...
## Code files
1. toy_problem.py: generates a folder containing the ROF tables for the desired number of realizations
...
2. reliability.py: generates a figure showing the relationship between system reliability and different $\alpha$ values
